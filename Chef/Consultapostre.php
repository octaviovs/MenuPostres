    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="postres.php">Postres</a></li> 
         <li><a href="Altapostre.php">Nuevo</a></li> 
      </ul>
        ...
        $x=0;
         foreach($arr as $item):
            ...
            echo "<td>".$item['Cantidad']."</td>";
             ...
             echo '<td>';
             echo '<button type="button" class="btn btn-success" data-toggle="modal" data-target="#ModalModificar'.$x.'" data-whatever="@mdo">Modificar</button>';
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="modificacionpostre.php" method="POST">
     
          <div class="form-group">
            <label for="recipient-name" class="control-label">Ingrediente:</label>
             <input type="hidden" class="form-control" id="recipient-name" name="tabla" value="R'.$_POST['pk_postre'].'">
             <input type="hidden" class="form-control" id="recipient-name" name="id" value="'.$item['id'].'">
            <input type="text" class="form-control" id="recipient-name" name="Ingrediente" value="'.$item['Ingrediente'].'">
          </div>
          <div class="form-group">
            <label for="message-text" class="control-label">Cantidad:</label>
             <input type="text" class="form-control" id="recipient-name" name="Cantidad" value="'.$item['Cantidad'].'">
          </div>
...
';
            ...
            echo '</td>';       
             ...
             echo '<td>';
            echo '<form action="bajaingrediente.php"  method="POST">';
            echo '<input type="hidden" name="tabla" value="'.$_POST['pk_postre'].'">';
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      ...
      <br>
      <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#ModalAgregarIngrediente" data-whatever="@mdo">Agregar</button> 
    </div>
